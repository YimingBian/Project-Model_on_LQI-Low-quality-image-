...
def Draw_pie_graphs(DATA, LABELS, TITLES, EXPLODES, START_ANGLE, LEGENDS, N_ROW = 1, AUTOPCT = "%.2f%%", FONTSIZE=10, SHADOW = True, FIGSIZE = (10,10),SHOW = False, DIR = "./Results", FILENAME = "pie_graph.png"):
    chart_num = len(DATA)
    tt_num = len(LABELS)
